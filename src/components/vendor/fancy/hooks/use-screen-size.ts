// Fancy Components (MIT, (c) Daniel Petho) — https://www.fancycomponents.dev/r/use-screen-size.json
// Bez úprav okrem formátovania. Breakpointy = Tailwind default (sm 640 … 2xl 1536).
