 ...
 * Alternatíva k ScrambledText bez GSAP a bez Motion (čistý React, ~2 kB gz) pre podstránky s islands="lite".
 * Úpravy: motion.span → span (Motion tu nerobil nič), reduced motion =
 * statický text (bez intervalu), sr-only nesie vždy pôvodný `text` (v origináli niesol rozmiešaný), sr-only cez
 * Tailwind triedu namiesto inline štýlu, znaková sada default X × . : + slovenské písmená, cn().
...
export default function DecryptedText({
  ...
  characters = 'XX××..::AÁBCČDĎEÉFGHIÍJKLĽMNŇOÓPRŔSŠTŤUÚVWXYZŽ0123456789',
  className = '',
  parentClassName = '',
  encryptedClassName = '',
  animateOn = 'hover',
